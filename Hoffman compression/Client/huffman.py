...
class HuffmanCoding:
    ...
    class HeapNode:
        ...
        def __str__(self):
            return "{} with {}".format(self.char,self.freq)
    ...
    def compress(self):
        ...
        with open(self.path, 'r') as input_file , open(output_path,'wb') as output:
        ...
        padded_encoded_text= self.pad_encoded_text(endcoded_text)
